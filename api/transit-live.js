// 511.org Transit API Caching Function (Azure Static Web Apps compatible)
...
/**
 * Azure Static Web Apps function handler
 */
module.exports = async function (context, req) {
  ...
  try {
    ...
    context.res.headers['Cache-Control'] = 'public, max-age=60';
