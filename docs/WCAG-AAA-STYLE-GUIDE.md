...
main { font-size: calc(1rem * var(--text-size-scale)); }
main h1 { font-size: calc(2.25rem * var(--text-size-scale)); }
main h2 { font-size: calc(1.875rem * var(--text-size-scale)); }
main h3 { font-size: calc(1.5rem * var(--text-size-scale)); }
```
...
```html
<!-- Correct -->
<a href="/about" class="text-primary-700 underline hover:text-primary-900">
  About us
</a>
...
<p id="email-error" class="text-red-800 dark:text-red-400">
