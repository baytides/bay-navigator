...
enum LocationLookup {
    ...
    static let zipToCity: [String: String] = [
        // Alameda County
    ...
    static let cityToCounty: [String: String] = [
        // Alameda County
    ...
    static func lookupCounty(_ input: String) -> String? {
    ...
    static func getSuggestions(for input: String, limit: Int = 5) -> [String] {
